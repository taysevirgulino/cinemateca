<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("noticia_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Notícia: Cadastro </td>
  </tr>
  <tr>
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
            ...
            <input type="text" name="FrmFotoArquivo" id="FrmFotoArquivo" class="frm" style="width:80%;" maxlength="255" value="<?=$frm_foto_arquivo?>">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmFotoCredito" id="FrmFotoCredito" class="frm" size="60" maxlength="255" value="" style="width:89%">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmFotoDescricao">&nbsp;Descrição:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmFotoDescricao" id="FrmFotoDescricao" class="frm" size="60" maxlength="255" value="" style="width:89%">
          </td>
        </tr>
		...
		<tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
			<div class="accordion">
                ...
                <h3><a id="bloco<?=$Bloco["id_area_publicacao_bloco"]?>" href="#<?=$Bloco["id_area_publicacao_bloco"]?>"><?=$Bloco["titulo"]." [".$Bloco["legenda"]."] ".(($Bloco["status"]==0) ? " (inativo)" : "" )?></a></h3>
                <div>
