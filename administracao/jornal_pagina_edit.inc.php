<?
	...
	if(!$obj->buscarJornalPagina(1, $ID)){ System::Redirect($link_list); }
	...
	if ( ! Validacao::isVazio($frm_bt) ){
		...
		if( Validacao::isVazio($label_alerta_erro) ){
			if(JornalPaginaManage::alterarJornalPagina($ID, null, $frm_id_jornal_edicao, $frm_id_jornal_estrutura, $frm_imagem)){
		...
		$frm_id_jornal_edicao = $obj->getIdJornalEdicao();
		$frm_id_jornal_estrutura = $obj->getIdJornalEstrutura();
		$frm_imagem = $obj->getImagem();
	}
?>