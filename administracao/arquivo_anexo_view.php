<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("arquivo_anexo_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Arquivo Anexo: Visualização </td>
  </tr>
  <tr>
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	            <? if(!empty($frm_id_arquivo)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:0px 0px 0px 0px;">
          			<a href="../files/arquivo_anexo/<?=$frm_id_arquivo?>" target="_blank" style="text-decoration:underline;"><?=$frm_id_arquivo?></a>
          		</div>
          	<? } ?>
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Arquivo Histórico: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	            <? if(!empty($frm_id_arquivo_historico)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:0px 0px 0px 0px;">
          			<a href="../files/arquivo_anexo/<?=$frm_id_arquivo_historico?>" target="_blank" style="text-decoration:underline;"><?=$frm_id_arquivo_historico?></a>
          		</div>
          	<? } ?>
          </td>
        </tr>
