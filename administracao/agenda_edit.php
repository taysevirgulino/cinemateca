<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("agenda_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Agenda: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <? } ?>
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<? if(!empty($frm_imagem)){ ?><img src="../images/agenda/A<?=$frm_imagem?>" style="margin:0px 0px 5px 0px;" /><br /><? } ?>
