<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("tempo_cidade_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Tempo Cidade: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmCodigo" id="FrmCodigo" class="frm" size="11" maxlength="11" value="<?=$frm_codigo?>">
          </td>
        </tr>
        <tr>
