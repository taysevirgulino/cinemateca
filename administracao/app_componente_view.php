<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_componente_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> App Componente: Visualização </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<table width="97" border="0" align="right" cellpadding="0" cellspacing="2">
      <tr>
        ...
        <td width="23"><a href="app_componente_edit.php?id=<?=$ID?>"><img src="images/botao/btn_edit_over.gif" width="22" height="21" border="0" alt="Clique para: Editar"></a></td>
        <td width="12"><a href="app_componente_remove.php?id=<?=$ID?>" onclick="javascript: return confirm('Deseja realmente EXCLUIR?');"><img src="images/botao/btn_remove_over.gif" width="21" height="21" border="0" alt="Clique para: Excluir"></a></td>
  ...
  <tr>
    <td>
	<form action="app_componente_view.php" method="post" name="frm" id="frm">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td>* Campos obrigat&oacute;rios </td>
          <td bgcolor="#CCCCCC" style="padding:3px 3px 3px 3px">
          	<input type="button" name="btVoltar" id="btVoltar" class="frm_botao" value="Voltar" onclick="javascript:window.open('app_componente_list.php', '_parent')" <?=$label_alerta_status?>>
		  </td>
        </tr>
      </table>
    </form>
