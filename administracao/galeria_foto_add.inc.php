<?
	...
	if ( ! Validacao::isVazio($frm_bt) ){
		...
		if( Validacao::isVazio($frm_id_galeria_album) ){
			$label_alerta_erro .="Preencha/Selecione o(a)  Galeria Álbum#";
		}
		$frm_foto = "";
		if( ! Validacao::isVazio($frm_foto_file["name"]) ){
			...
			$label_alerta_erro .="Preencha/Selecione o(a)  Foto#";
		}

		if( Validacao::isVazio($label_alerta_erro) ){
			if(GaleriaFotoManage::inserirGaleriaFoto(-1, null, null, $frm_id_galeria_album, $frm_credito, $frm_descricao, $frm_foto, $frm_prioridade)){
