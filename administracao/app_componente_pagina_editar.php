<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_componente_pagina_editar.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo">Componente P&aacute;gina: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><form action="app_componente_pagina_editar.php?id=<?=$ID?>" method="post" name="frm" id="frm">
