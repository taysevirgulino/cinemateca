<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("cronograma_etapa_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Cronograma Etapa: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmIdCronogramaTipo">&nbsp;Tipo: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	  <select name="FrmIdCronogramaTipo" class="frm" id="FrmIdCronogramaTipo" style="width:500px;">
                <? for($i=0; $i < count($VObjCronogramaTipo); $i++){ ?>
                <option value="<?=$VObjCronogramaTipo[$i]["id_cronograma_tipo"]?>" <? if($VObjCronogramaTipo[$i]["id_cronograma_tipo"] == $frm_id_cronograma_tipo){ print("selected"); }?>><?=$VObjCronogramaTipo[$i]["titulo"]?></option>
                <? } ?>
              </select>
          </td>
        </tr>
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmPorcentagem">&nbsp;Porcentagem:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmPorcentagem" id="FrmPorcentagem" class="frm valor" size="11" maxlength="11" value="<?=$frm_porcentagem?>">
          </td>
        </tr>
        <tr>
    ...
    <script language="javascript">document.getElementById("FrmIdCronogramaTipo").focus();</script>
    ...
    <!--
        ...
        var a_fields = {
            'FrmIdCronogramaTipo':{'l':' Cronograma Tipo','t':'labelFrmIdCronogramaTipo','r':true},
            'FrmTitulo':{'l':' Título','t':'labelFrmTitulo','r':true},
            'FrmDescricao':{'l':' Descrição','t':'labelFrmDescricao'},
            'FrmPorcentagem':{'l':' Porcentagem','t':'labelFrmPorcentagem'},
