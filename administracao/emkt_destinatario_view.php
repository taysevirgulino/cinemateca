<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("emkt_destinatario_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Emkt Destinatário: Visualização </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="" method="post" name="frm" id="frm">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Emkt Disparo: * </td>
