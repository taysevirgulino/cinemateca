<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("mural_recado_edit.inc.php"); require_once("script/editorhtml/fckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Mural Recado: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onSubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<textarea name="FrmTexto" id="FrmTexto" cols="40" rows="7" style="width:98%" class="frm"><?=$frm_texto?></textarea>
          </td>
        </tr>
        <tr>
