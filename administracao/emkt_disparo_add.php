<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("emkt_disparo_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Emkt Disparo: Cadastro </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <? } ?>
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmAgendamento" id="FrmAgendamento" class="frm" size="19" maxlength="19" value="<?=$frm_agendamento?>">&nbsp;<input type="button" name="BTAgendamento" id="BTAgendamento" class="frm" value="..." ><script type="text/javascript"> Calendar.setup({ inputField:"FrmAgendamento", ifFormat:"%d/%m/%Y %H:%M:%S", showsTime:true, button:"BTAgendamento", singleClick:true, step:1 }); </script>&nbsp;<span class="frm_exemplo">Ex: <?=date("d/m/Y H:i:s")?></span>
          </td>
        </tr>
        <tr>
