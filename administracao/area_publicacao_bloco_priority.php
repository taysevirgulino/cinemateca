<?
	...
	if(!$obj_atual->buscarAreaPublicacaoBloco(1, $ID_ATUAL)){ System::Redirect($link_list); }

	$obj_alterar = new AreaPublicacaoBloco();
	if(!$obj_alterar->buscarAreaPublicacaoBloco(1, $ID_ALTERAR)){ System::Redirect($link_list); }
