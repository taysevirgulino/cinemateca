<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("cronograma_farol_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Cronograma Farol: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmCor">&nbsp;Cor:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmCor" id="FrmCor" class="frm" size="20" maxlength="20" value="<?=$frm_cor?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmPeso">&nbsp;Peso:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmPeso" id="FrmPeso" class="frm" size="9" maxlength="9" value="<?=$frm_peso?>">
          </td>
        </tr>
        <tr>
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmCor':{'l':' Cor','t':'labelFrmCor'},
            'FrmPeso':{'l':' Peso','t':'labelFrmPeso'},
