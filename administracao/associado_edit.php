<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("associado_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Associado: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <? } ?>
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmDataNascimento" id="FrmDataNascimento" class="frm" size="10" maxlength="10" value="<?=$frm_data_nascimento?>">&nbsp;<input type="button" name="BTDataNascimento" id="BTDataNascimento" class="frm" value="..." ><script type="text/javascript"> Calendar.setup({ inputField:"FrmDataNascimento", ifFormat:"%d/%m/%Y", showsTime:true, button:"BTDataNascimento", singleClick:true, step:1 }); </script>&nbsp;<span class="frm_exemplo">Ex: <?=date("d/m/Y")?></span>
          </td>
        </tr>
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	...
          	<? if(!empty($frm_imagem)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:5px 0px 0px 0px;">
          			<img src="../images/associado/<?=$frm_imagem?>" style="position:relative; float:left; margin:0px 5px 5px 0px;" />
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	...
          	<? if(!empty($frm_empresa_imagem)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:5px 0px 0px 0px;">
          			<img src="../images/associado/<?=$frm_empresa_imagem?>" style="position:relative; float:left; margin:0px 5px 5px 0px;" />
          			<label><input type="checkbox" name="FrmEmpresaImagemRemove" id="FrmEmpresaImagemRemove" value="1" />&nbsp;Remover imagem?</label>
          		</div>
          	<? } ?>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmDatahoraCadastro" id="FrmDatahoraCadastro" class="frm" size="19" maxlength="19" value="<?=$frm_datahora_cadastro?>" onkeydown="fncFormataData('frm', 'FrmDatahoraCadastro')">&nbsp;<input type="button" name="BTDatahoraCadastro" id="BTDatahoraCadastro" class="frm" value="..." ><script type="text/javascript"> Calendar.setup({ inputField:"FrmDatahoraCadastro", ifFormat:"%d/%m/%Y %H:%M:%S", showsTime:true, button:"BTDatahoraCadastro", singleClick:true, step:1 }); </script>&nbsp;<span class="frm_exemplo">Ex: <?=date("d/m/Y H:i:s")?></span>
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmDatahoraEdicao">&nbsp;Data/Hora Edição:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmDatahoraEdicao" id="FrmDatahoraEdicao" class="frm" size="19" maxlength="19" value="<?=$frm_datahora_edicao?>" onkeydown="fncFormataData('frm', 'FrmDatahoraEdicao')">&nbsp;<input type="button" name="BTDatahoraEdicao" id="BTDatahoraEdicao" class="frm" value="..." ><script type="text/javascript"> Calendar.setup({ inputField:"FrmDatahoraEdicao", ifFormat:"%d/%m/%Y %H:%M:%S", showsTime:true, button:"BTDatahoraEdicao", singleClick:true, step:1 }); </script>&nbsp;<span class="frm_exemplo">Ex: <?=date("d/m/Y H:i:s")?></span>
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmDatahoraLogin">&nbsp;Data/Hora Login:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmDatahoraLogin" id="FrmDatahoraLogin" class="frm" size="19" maxlength="19" value="<?=$frm_datahora_login?>" onkeydown="fncFormataData('frm', 'FrmDatahoraLogin')">&nbsp;<input type="button" name="BTDatahoraLogin" id="BTDatahoraLogin" class="frm" value="..." ><script type="text/javascript"> Calendar.setup({ inputField:"FrmDatahoraLogin", ifFormat:"%d/%m/%Y %H:%M:%S", showsTime:true, button:"BTDatahoraLogin", singleClick:true, step:1 }); </script>&nbsp;<span class="frm_exemplo">Ex: <?=date("d/m/Y H:i:s")?></span>
          </td>
        </tr>
        <tr>
