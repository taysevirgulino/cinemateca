<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("painel_menu_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Painel Menu: Cadastro </td>
  </tr>
  <tr>
  ...
  <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?php 
          	     foreach ($VObjUsuarioPerfil as $key => $value) {
          	         print sprintf('<div style="position:relative; float:left; width:100%%; padding:5px 5px 0px 0px;"><label><input type="checkbox" name="FrmIdUsuarioPerfil[]" value="%s" /> %s</label></div>', $value["id_usuario_perfil"], $value["titulo"]);
          	     }
          	?>
          </td>
        </tr>
    ...
    <!--
        ...
        var a_fields = {
            'FrmIdPainelMenuPai':{'l':' Painel Menu','t':'labelFrmIdPainelMenuPai','r':true},
