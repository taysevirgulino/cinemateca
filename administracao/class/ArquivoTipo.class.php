<? 
class ArquivoTipo extends AbstractEntity implements EntityInterface { 
	 
	protected $id_arquivo_tipo, $identificador, $titulo, $prioridade, $status;
	 
	public function setArquivoTipo($IdArquivoTipo, $Identificador, $Titulo, $Prioridade, $Status){ 
