<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("arquivo_disciplina_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Arquivo Disciplina: Cadastro </td>
  </tr>
  <tr>
