<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("usuario_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Usuário: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmIdUsuarioPerfil">&nbsp;Perfil: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	  <select name="FrmIdUsuarioPerfil" class="frm" id="FrmIdUsuarioPerfil" style="width:500px;">
				<? for($i=0; $i < count($VObjUsuarioPerfil); $i++){ ?>
				<option value="<?=$VObjUsuarioPerfil[$i]["id_usuario_perfil"]?>" <? if($VObjUsuarioPerfil[$i]["id_usuario_perfil"] == $frm_id_usuario_perfil){ print("selected"); }?>><?=$VObjUsuarioPerfil[$i]["titulo"]?></option>
				<? } ?>
			  </select>
          </td>
        </tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	...
          	<? if(!empty($frm_imagem)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:5px 0px 0px 0px;">
          			<img src="../images/usuario/A<?=$frm_imagem?>" style="position:relative; float:left; margin:0px 5px 5px 0px;" />
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmLogin">&nbsp;Login: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmLogin" id="FrmLogin" class="frm" size="40" maxlength="255" value="<?=$frm_login?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmSenha">&nbsp;Senha: </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="password" name="FrmSenha" id="FrmSenha" class="frm" size="40" maxlength="255" value=""><br />
			<span class="frm_exemplo">Preencha caso queira alterar</span>
          </td>
        </tr>
        <tr>
    ...
    <script language="javascript">document.getElementById("FrmIdUsuarioPerfil").focus();</script>
    ...
    <!--
        ...
        var a_fields = {
            'FrmIdUsuarioPerfil':{'l':' Usuário Perfil','t':'labelFrmIdUsuarioPerfil','r':true},
            ...
            'FrmLogin':{'l':' Login','t':'labelFrmLogin','r':true},
            'FrmSenha':{'l':' Senha','t':'labelFrmSenha'},
