<?
	...
	$objPHPExcel->getActiveSheet()->setCellValue("A1", utf8_encode("Código Editoria"));
	...
	$objPHPExcel->getActiveSheet()->setCellValue("F1", utf8_encode("Descrição"));
	...
	$objPHPExcel->getActiveSheet()->setCellValue("H1", utf8_encode("Imagem Página"));
