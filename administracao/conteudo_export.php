<?
	...
	$vobj = ConteudoManage::consultarConteudo(3, SearchMounter::MounterByQueryComparerOrder(ConteudoAttribute::_Table(), $export["SearchQueryComparerCollection"], $export["SearchQueryOrderCollection"]));

	$objPHPExcel = new PHPExcel();
	$objPHPExcel->getProperties()->setCreator("ArtemSite")
								 ->setLastModifiedBy("ArtemSite")
								 ->setTitle("Dados Conteudo")
								 ->setSubject("Dados Conteudo")
								 ->setDescription("Dados Conteudo")
								 ->setKeywords("Dados Conteudo")
	...
	$objPHPExcel->getActiveSheet()->setCellValue("A1", utf8_encode("Código Conteúdo"));
	...
	for ($i = 0; $i < count($vobj); $i++) {
		$objPHPExcel->getActiveSheet()->setCellValue("A".($i+2), utf8_encode($vobj[$i]["id_conteudo"]));
	...
	$fileName = "Conteudo_".date("d-m-Y_H-i-s").".xlsx";
