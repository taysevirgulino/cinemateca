<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("relatorio_usuario_acesso_hora.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo">Relat&oacute;rio de Acessos Di&aacute;rios: por Hora </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
      <tr bgcolor="#CCCCCC" class="tabela_titulo">
        <td width="60%" height="20">&nbsp;Ano/M&ecirc;s/Dia [Hora]</td>
      ...
      ?>
      <tr>
        <td bgcolor="#F2F2F2" class="tabela_texto">&nbsp;<span style="font-size:12px; font-weight:bold; color:#333"><?=$vobj[$i][0]?></span></td>
