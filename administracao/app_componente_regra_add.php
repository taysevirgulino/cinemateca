<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_componente_regra_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> App Componente Regra: Cadastro </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
	<form action="app_componente_regra_add.php" method="post" name="frm" id="frm" enctype="multipart/form-data">
