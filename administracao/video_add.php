<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("video_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Vídeo: Cadastro </td>
  </tr>
  <tr>
