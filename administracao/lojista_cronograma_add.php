<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("lojista_cronograma_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Lojista Cronograma: Cadastro </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <? } ?>
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmPrevisaoInicio" id="FrmPrevisaoInicio" class="frm" size="10" maxlength="10" value="<?=$frm_previsao_inicio?>" onkeydown="fncFormataData('frm', 'FrmPrevisaoInicio')">&nbsp;<input type="button" name="BTPrevisaoInicio" id="BTPrevisaoInicio" class="frm" value="..." ><script type="text/javascript"> Calendar.setup({ inputField:"FrmPrevisaoInicio", ifFormat:"%d/%m/%Y", showsTime:true, button:"BTPrevisaoInicio", singleClick:true, step:1 }); </script>&nbsp;<span class="frm_exemplo">Ex: <?=date("d/m/Y")?></span>
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmPrevisaoFim">&nbsp;Previsão Fim:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmPrevisaoFim" id="FrmPrevisaoFim" class="frm" size="10" maxlength="10" value="<?=$frm_previsao_fim?>" onkeydown="fncFormataData('frm', 'FrmPrevisaoFim')">&nbsp;<input type="button" name="BTPrevisaoFim" id="BTPrevisaoFim" class="frm" value="..." ><script type="text/javascript"> Calendar.setup({ inputField:"FrmPrevisaoFim", ifFormat:"%d/%m/%Y", showsTime:true, button:"BTPrevisaoFim", singleClick:true, step:1 }); </script>&nbsp;<span class="frm_exemplo">Ex: <?=date("d/m/Y")?></span>
          </td>
        </tr>
        <tr>
