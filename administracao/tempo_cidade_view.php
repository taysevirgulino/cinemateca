<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("tempo_cidade_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Tempo Cidade: Visualização </td>
  </tr>
  <tr>
