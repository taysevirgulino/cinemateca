<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_componente_pagina_list.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> App Componente Pagina: Listagem </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<table width="97" border="0" align="right" cellpadding="0" cellspacing="2">
      <tr>
        <td width="22"><a href="app_componente_pagina_add.php"><img src="images/botao/btn_add_over.gif" width="22" height="21" border="0" alt="Clique para: Cadastrar"></a></td>
        ...
        <td width="82"><a href="app_componente_pagina_list.php"><img src="images/botao/btn_copy_norm.gif" width="22" height="21" border="0" alt="Clique para: Listar"></a></td>
      </tr>
    </table>	
	</td>
  </tr>
  ...
  <tr>
    <td>
	<form id="frm" name="frm" method="get" action="app_componente_pagina_list.php">
      <table width="100%" border="0">
        ...
        <tr>
          <td colspan="4" align="right" height="25"><input name="pesquisar" type="submit" class="frm_botao" id="pesquisar" value="Pesquisar" />
            <input name="cancelar" type="button" class="frm_botao" id="cancelar" value="Cancelar" onclick="javascript:window.open('app_componente_pagina_list.php', '_parent');" /></td>
        </tr>
		<tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
      <tr bgcolor="#CCCCCC" class="tabela_titulo">
        <td height="20" width="40%"> Url (Endereço)</td>
        <td height="20" width="40%"> Descrição</td>
      ...
      <tr>
        ...
        <td height="25" bgcolor="#CCCCCC" align="center"><a href="app_componente_pagina_view.php?id=<?=$vobj[$i][0]?>"><img src="images/botao/Search.gif" width="18" height="18" border="0" title="Visualizar | Código: <?=$vobj[$i][0]?>" /></a>&nbsp;<a href="app_componente_pagina_edit.php?id=<?=$vobj[$i][0]?>"><img src="images/botao/Edit.gif" title="Editar | Código: <?=$vobj[$i][0]?>" width="18" height="18" border="0"></a><a href="app_componente_pagina_remove.php?id=<?=$vobj[$i][0]?>" onclick="javascript: return confirm('Deseja realmente EXCLUIR?');"><img src="images/botao/Delete.gif" title="Excluir | Código: <?=$vobj[$i][0]?>" width="18" height="18" border="0"></a></td>
      </tr>
      <?
      	} 
		if($cont <= 0){
      ?>
	  <tr>
	  	<td colspan="3" style="height:30px; font-weight:bold; font-size:14px; text-align:center">Nenhum registro afetado!</td>
	  </tr>
	  <?
	  	}
	  ?>
