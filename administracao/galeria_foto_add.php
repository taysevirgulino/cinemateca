<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("galeria_foto_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="10" style="font-size:12px; font-weight:bold; color:#FF0000">Álbum: <?=$album_label?></td>
  </tr>
  <tr>
    <td height="10"></td>
  </tr>  
  ...
  <tr>
	...
	<form action="<?=$link_add?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmCredito">&nbsp;Crédito:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmCredito" id="FrmCredito" class="frm" size="80" maxlength="255" value="<?=$frm_credito?>">
          </td>
        </tr>
        <tr>
    ...
    <script language="javascript">document.getElementById("FrmIdGaleriaAlbum").focus();</script>
    ...
    <!--
        ...
        var a_fields = {
            'FrmCredito':{'l':' Crédito','t':'labelFrmCredito'},
            'FrmDescricao':{'l':' Descrição','t':'labelFrmDescricao'},
            'FrmFotoFile':{'l':' Foto','t':'labelFrmFoto','r':true,'f':'image'},
