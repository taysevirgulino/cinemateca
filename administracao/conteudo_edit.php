<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("conteudo_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Conteúdo: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmCodigo">&nbsp;Código: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmCodigo" id="FrmCodigo" class="frm" size="50" maxlength="50" value="<?=$frm_codigo?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmLegenda">&nbsp;Legenda:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmLegenda" id="FrmLegenda" class="frm" size="80" maxlength="255" value="<?=$frm_legenda?>">
          </td>
        </tr>
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	...
          	<? if(!empty($frm_imagem)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:5px 0px 0px 0px;">
          			<img src="../images/conteudo/<?=$frm_imagem?>" style="position:relative; float:left; margin:0px 5px 5px 0px;" />
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmCodigo':{'l':' Código','t':'labelFrmCodigo','r':true},
