<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("arquivo_download_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Arquivo Download: Visualização </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="" method="post" name="frm" id="frm">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Arquivo Anexo: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	            <? if(!empty($frm_id_arquivo_anexo)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:0px 0px 0px 0px;">
          			<a href="../files/arquivo_download/<?=$frm_id_arquivo_anexo?>" target="_blank" style="text-decoration:underline;"><?=$frm_id_arquivo_anexo?></a>
          		</div>
          	<? } ?>
          </td>
        </tr>
