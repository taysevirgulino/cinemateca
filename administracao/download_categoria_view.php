<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("download_categoria_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Download Categoria: Visualização </td>
  </tr>
  <tr>
