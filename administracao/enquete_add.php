<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("enquete_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Enquete: Cadastro </td>
  </tr>
  <tr>
	...
	<form action="<?=$link_add?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmResposta0" id="FrmResposta0" class="frm" size="80" maxlength="255" value="<?=$frm_resposta[0]?>">
          </td>
        </tr>
		<? for($i=1; $i < $qtd_alternativa; $i++){ ?>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmResposta<?=$i?>">&nbsp;Alternativa <?=$i+1?>: </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmResposta<?=$i?>" id="FrmResposta<?=$i?>" class="frm" size="80" maxlength="255" value="<?=$frm_resposta[$i]?>">
          </td>
        </tr>
		<? } ?>
        <tr>
