...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Multimídia: Upload </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="video_add.php" method="post" name="frm" id="frm" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td height="25" colspan="2" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Upload de multimídias (v&iacute;deos e áudios):           </td>
          </tr>
        <tr>
          <td height="25" colspan="2" bgcolor="#FFFFFF">
	            Formatos Válidos (extenções):<br />
                - <strong>Vídeo:</strong> .flv e .wmv<br />
                - <strong>Áudio:</strong> .mp3 e .wma<br />
          </td>
        </tr>
        <tr>
          <td height="25" colspan="2" bgcolor="#FFFFFF" class="frm_texto" align="center">
            <?php /*?><applet
            	...
            	Seu navegador (browser) não tem Java Applets instalado ou está desabilitado.<br /><br />
        ...
        <!--<tr>
          ...
          <td width="75%" bgcolor="#CCCCCC" style="padding:3px 3px 3px 3px">
          	<input type="button" name="btSubmit" id="btSubmit" class="frm_botao" value="Próximo (Cadastrar Multimídia) >" onClick="javascript:window.open('multimidia_add.php', '_parent')"></td>
        </tr>-->
      </table>
    </form>
	</td>
