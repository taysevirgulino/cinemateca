<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("emkt_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Newsletter: Cadastro </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_add?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmTitulo">&nbsp;Título da Newsletter: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmTitulo" id="FrmTitulo" class="frm" size="80" maxlength="255" value="<?=$frm_titulo?>">          </td>
        </tr>
        <tr>
          <td height="25" colspan="2" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmAssunto2">&nbsp;Informa&ccedil;&otilde;es do E-mail</td>
          </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmAssunto">&nbsp;Assunto: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmAssunto" id="FrmAssunto" class="frm" size="80" maxlength="255" value="<?=$frm_assunto?>">          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmRemetenteNome">&nbsp;Nome do Remetente: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmRemetenteNome" id="FrmRemetenteNome" class="frm" size="80" maxlength="255" value="<?=$frm_remetente_nome?>">          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmRemetenteEmail">&nbsp;E-mail do Remetente: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmRemetenteEmail" id="FrmRemetenteEmail" class="frm" size="80" maxlength="255" value="<?=$frm_remetente_email?>">          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmMensagemHtml">&nbsp;Mensagem em Html: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?php $CKEditor = new CKEditor(); $CKEditor->returnOutput = true; $CKEditor->basePath="script/editorhtml/"; $CKEditor->config['height'] = 500; print $CKEditor->editor("FrmMensagemHtml", $frm_mensagem_html); ?>          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmMensagemTexto">&nbsp;Mensagem em Texto:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<textarea name="FrmMensagemTexto" id="FrmMensagemTexto" cols="" rows="7" class="frm" style="width:99%"><?=$frm_mensagem_texto?></textarea>
          </td>
        </tr>
        <tr>
          ...
          <td bgcolor="#CCCCCC" style="padding:3px 3px 3px 3px">
            ...
            <input type="reset"  name="btReset"    id="btReset"  class="frm_botao" value="Limpar" <?=$label_alerta_status?>>		  </td>
        </tr>
      </table>
    </form>
    ...
    <!--
		function _Validar(){
			var objFrmMensagemHtml = CKEDITOR.instances.FrmMensagemHtml;
			if(objFrmMensagemHtml != null){
				objFrmMensagemHtml.updateElement();
			}
			return vFrm.exec();
		}
        var a_fields = {
            ...
            'FrmRemetenteNome':{'l':' Remetente Nome','t':'labelFrmRemetenteNome','r':true},
            'FrmRemetenteEmail':{'l':' Remetente E-mail','t':'labelFrmRemetenteEmail','r':true,'f':'email'},
            'FrmMensagemHtml':{'l':' Mensagem Html','t':'labelFrmMensagemHtml','r':true},
            'FrmMensagemTexto':{'l':' Mensagem Texto','t':'labelFrmMensagemTexto'},
