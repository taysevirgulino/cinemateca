<?
	$link_add = "galeria_categoria_add.php";
	$link_edit = "galeria_categoria_edit.php";
	$link_remove = "galeria_categoria_remove.php";
	$link_list = "galeria_categoria_list.php";
	...
	$SearchQueryComparerCollection[] = new SearchQueryComparer(GaleriaCategoriaAttribute::IdeOrigem(), SearchComparer::Igual(), SearchCondition::E(), Current::IdeOrigem());
	if(empty($busca_campo)){
		$busca_campo = GaleriaCategoriaAttribute::Nome();
	}
	if(!empty($chave)){
	...
	if(!empty($ordenacao_campo)){
		...
		$SearchQueryOrderCollection[] = new SearchQueryOrder(GaleriaCategoriaAttribute::Prioridade(), SearchOrder::Crescente());
		$ordenacao_campo = GaleriaCategoriaAttribute::Prioridade();
	...
	if(!Validacao::isVazio($exportar)){
		...
		$export = array();
		$export["Object"] = "GaleriaCategoria";
		...
		System::Redirect("galeria_categoria_export.php?ide=$export_ide");
	}

	// Paginчуo de resultados ----------------------------------------------------------|
	$vobjCount = GaleriaCategoriaManage::count( SearchMounter::MounterByQueryCount(GaleriaCategoriaAttribute::_Table(), $SearchQueryComparerCollection) );
	...
	$vobj = GaleriaCategoriaManage::consultar(SearchMounter::MounterByQueryLimit(GaleriaCategoriaAttribute::_Table(), $SearchQueryComparerCollection, $SearchQueryOrderCollection, $paginacao->getPaginacaoInicio(), $paginacao->getRegistrosPorPagina()));

	$Orders = SearchOrder::_GetAllOrders();
	$Comparers = SearchComparer::_GetAllComparers();
	$Attributes = GaleriaCategoriaAttribute::_GetAllAttributes();
?>