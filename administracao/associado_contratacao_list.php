...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Associado Contratação: Listagem </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
      ...
      <tr>
        ...
        <td bgcolor="<?=$bgcolor?>" align="center"><a href="associado_contratacao_view.php?id=<?=$vobj[$i]["id_associado_contratacao"]?>&back=<?=$link_back;?>"><img src="images/botao/Search.gif" width="18" height="18" border="0" title="Visualizar | Código: <?=$vobj[$i]["id_associado_contratacao"]?>" /></a>&nbsp;<a href="associado_contratacao_edit.php?id=<?=$vobj[$i]["id_associado_contratacao"]?>&back=<?=$link_back;?>"><img src="images/botao/Edit.gif" title="Editar | Código: <?=$vobj[$i]["id_associado_contratacao"]?>" width="18" height="18" border="0"></a><a href="associado_contratacao_remove.php?id=<?=$vobj[$i]["id_associado_contratacao"]?>&back=<?=$link_back;?>" onclick="javascript: return confirm('Deseja realmente EXCLUIR?');"><img src="images/botao/Delete.gif" title="Excluir | Código: <?=$vobj[$i]["id_associado_contratacao"]?>" width="18" height="18" border="0"></a></td>
      </tr>
      <?
      	} 
		if($cont <= 0){
