<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("acesso_rapido_bloco_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Acesso Rápido Bloco: Visualização </td>
  </tr>
  <tr>
