<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("fale_conosco_assunto_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Fale Conosco Assunto: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmEmails" id="FrmEmails" class="frm" size="80" maxlength="255" value="<?=$frm_emails?>">
          </td>
        </tr>
        <tr>
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmEmails':{'l':' E-mails','t':'labelFrmEmails','f':'email'},
