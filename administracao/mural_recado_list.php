<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("mural_recado_list.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Mural Recado: Listagem </td>
  </tr>
  <tr>
  ...
  <form id="frmOperacao" name="frmOperacao" method="post" action="mural_recado_operation.php">
  <tr>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr bgcolor="#CCCCCC" class="tabela_titulo">
        ...
        <td height="20" width="30%" align="left"><a href="<?="?busca-comparacao=$busca_comparacao&chave=$chave&busca-campo=$busca_campo&ordenacao-campo=texto&ordenacao-ordem=$ordenacao_ordem_inverso&pg=$PG"?>" title="Ordernar por: Texto">Texto</a></td>
      ...
      <tr>
        ...
        <td bgcolor="<?=$bgcolor?>" class="tabela_texto" align="center"><input type="checkbox" name="CheckBoxIdOperacao<?=$i?>" id="CheckBoxIdOperacao<?=$i?>" value="<?=$vobj[$i]["id_mural_recado"]?>" class="InputOperacao" /></td>
        <td height="25" bgcolor="#CCCCCC" align="center" style="padding:2px;"><a href="mural_recado_view.php?id=<?=$vobj[$i]["id_mural_recado"]?>"><img src="images/botao/Search.gif" width="18" height="18" border="0" alt="Visualizar | Código: <?=$vobj[$i]["id_mural_recado"]?>" /></a>&nbsp;<a href="mural_recado_edit.php?id=<?=$vobj[$i]["id_mural_recado"]?>"><img src="images/botao/Edit.gif" alt="Editar | Código: <?=$vobj[$i]["id_mural_recado"]?>" width="18" height="18" border="0"></a><a href="mural_recado_remove.php?id=<?=$vobj[$i]["id_mural_recado"]?>" onclick="javascript: return confirm('Deseja realmente EXCLUIR?');"><img src="images/botao/Delete.gif" alt="Excluir | Código: <?=$vobj[$i]["id_mural_recado"]?>" width="18" height="18" border="0"></a></td>
      </tr>
      <?
      	} 
		if($cont <= 0){
