<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("artigo_articulista_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Artigo Articulista: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmPerfil">&nbsp;Perfil: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?php $CKEditor = new CKEditor(); $CKEditor->returnOutput = true; $CKEditor->basePath="script/editorhtml/"; $CKEditor->config['height'] = 500; print $CKEditor->editor("FrmPerfil", $frm_perfil); ?>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmFoto">&nbsp;Foto:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="file" name="FrmFotoFile" id="FrmFotoFile" class="frm" size="60" maxlength="255" value="">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmFoto">&nbsp;Foto Antiga:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<img src="../images/artigo_articulista/A<?=$frm_foto?>" />
          </td>
        </tr>
        <tr>
    ...
    <!--
		function _Validar(){
			var objFrmPerfil = CKEDITOR.instances.FrmPerfil;
			if(objFrmPerfil != null){
				objFrmPerfil.updateElement();
			}
			return vFrm.exec();
		}
        var a_fields = {
            'FrmNome':{'l':' Nome','t':'labelFrmNome','r':true},
            'FrmPerfil':{'l':' Perfil','t':'labelFrmPerfil','r':true},
            'FrmEmail':{'l':' E-mail','t':'labelFrmEmail','f':'email'},
            'FrmTelefone':{'l':' Telefone','t':'labelFrmTelefone'},
            'FrmFotoFile':{'l':' Foto','t':'labelFrmFoto'},
