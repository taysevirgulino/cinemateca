<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_componente_menu_cadastrar.inc.php"); ?>
<?
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo">Componente Menu: Cadastro </td>
  </tr>
  <tr>
          ...
          <td width="398" bgcolor="#F2F2F2"><table width="100%"  border="0" cellspacing="3" cellpadding="0">
            <tr>
			  ...
			  <select name="sltMenuPai" class="frm" id="sltMenuPai">
				...
				?>
                <option value="<?=$acms[$i]->getIdAppComponenteMenu()?>" <? if($acms[$i]->getIdAppComponenteMenu() == $frm["menupai"]){ print("selected"); }?>><?=$acms[$i]->getDescricao()?></option>
				<?
					}//for
				?>
              </select>
        ...
        <tr>
          ...
          <td width="398" bgcolor="#F2F2F2"><table width="100%"  border="0" cellspacing="3" cellpadding="0">
            <tr>
			  ...
			  [<a href="menu_icones_listar.php" target="_blank">Listar</a>]			  </td>
