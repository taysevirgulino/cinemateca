      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
            ...
            <a href="enquete_alternativa_priority.php?id=<?=$ID?>&idatual=<?=$frm_resposta[$i][1]?>&idalterar=<?=$frm_resposta[$i-$h][1]?>" onclick="javascript: return confirm('Deseja realmente Alterar a Prioridade?');"><img src="images/seta1.gif" width="15" height="15" border="0" alt="Alterar Prioridade | Código: <?=$frm_resposta[$i][1]?> por <?=$frm_resposta[$i-$h][1]?>" /></a>
          </td>
        </tr>
		<? } ?>
        <tr>
