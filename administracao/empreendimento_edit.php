<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("empreendimento_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Empreendimento: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onSubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmAreaBrutaLocavel">&nbsp;Área Bruta Locável:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmAreaTotalConstruida">&nbsp;Área Total Construida:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmAreaBrutaLocavel':{'l':' Área Bruta Locavel','t':'labelFrmAreaBrutaLocavel'},
            'FrmAreaTotalConstruida':{'l':' Área Total Construida','t':'labelFrmAreaTotalConstruida'},
