<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_usuario_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> App Usuário: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
	<form action="app_usuario_edit.php?id=<?=$ID?>" method="post" name="frm" id="frm" enctype="multipart/form-data">
    ...
    <? } ?>
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	...
          	<span class="frm_exemplo">OBS: Informe caso queria alterar.</span> </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td bgcolor="#CCCCCC" style="padding:3px 3px 3px 3px">
           ...
           <input type="button" name="btCancelar" id="btCancelar" class="frm_botao" value="Cancelar/Voltar" onclick="javascript:window.open('app_usuario_list.php', '_parent')" <?=$label_alerta_status?>>
		  </td>
        </tr>
      </table>
    </form>
