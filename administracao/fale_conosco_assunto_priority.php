<?
	...
	if(!$obj_atual->buscarFaleConoscoAssunto(1, $ID_ATUAL)){ System::Redirect($link_list); }

	$obj_alterar = new FaleConoscoAssunto();
	if(!$obj_alterar->buscarFaleConoscoAssunto(1, $ID_ALTERAR)){ System::Redirect($link_list); }
