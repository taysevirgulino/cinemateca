<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("arquivo_historico_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Arquivo Histórico: Visualização </td>
  </tr>
  <tr>
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          		...
          		<div style="position:relative; float:left; width:100%; margin:0px 0px 0px 0px;">
          			<a href="../files/arquivo_historico/<?=$frm_id_arquivo?>" target="_blank" style="text-decoration:underline;"><?=$frm_id_arquivo?></a>
          		</div>
          	<? } ?>
          </td>
        </tr>
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          		...
          		<div style="position:relative; float:left; width:100%; margin:0px 0px 0px 0px;">
          			<a href="../files/arquivo_historico/<?=$frm_id_arquivo_tipo?>" target="_blank" style="text-decoration:underline;"><?=$frm_id_arquivo_tipo?></a>
          		</div>
          	<? } ?>
          </td>
        </tr>
