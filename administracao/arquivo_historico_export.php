<?
	...
	$objPHPExcel->getActiveSheet()->setCellValue("A1", utf8_encode("Código Arquivo Histórico"));
	...
	$objPHPExcel->getActiveSheet()->setCellValue("F1", utf8_encode("Usuário Responsável"));
