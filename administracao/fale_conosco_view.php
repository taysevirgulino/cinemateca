<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("fale_conosco_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Fale Conosco: Visualização </td>
  </tr>
  <tr>
	...
	<form action="" method="post" name="frm" id="frm">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr style="display: none;">
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Cidade / Estado:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?=$frm_cidade?> / <?=$frm_estado?>
          </td>
        </tr>
        <tr>
