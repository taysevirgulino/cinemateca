<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("disciplina_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Disciplina: Cadastro </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_add?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmConteudo">&nbsp;Conteúdo: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmConteudo':{'l':' Conteúdo','t':'labelFrmConteudo','r':true},
