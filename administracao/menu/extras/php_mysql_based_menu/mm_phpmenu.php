...
/*
   ...
   Milonic DHTML Menu PHP Function Module  mm_phpmenu.php version 1.8 - January 12 2009
...
{
	global $pathToCodeFiles,$menuCodeDrawn,$menuIncFiles;
	
	if($menuCodeDrawn==0)
	{
		echo "
<script language=\"JavaScript\" src=\"$pathToCodeFiles$menuIncFiles[0]\" type=\"text/javascript\"></script>
";
}
	flush();
	$menuCodeDrawn++;
...
function doquery($query)
{
	...
	{
		if (!preg_match("/^update/", $query)) return mysql_fetch_array($qry);
	}
}
