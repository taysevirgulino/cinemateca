<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_usuario_grupo_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> App Usuário Grupo: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<table width="97" border="0" align="right" cellpadding="0" cellspacing="2">
      <tr>
        ...
        <td width="12"><a href="app_usuario_grupo_remove.php?id=<?=$ID?>" onclick="javascript: return confirm('Deseja realmente EXCLUIR?');"><img src="images/botao/btn_remove_over.gif" width="21" height="21" border="0" alt="Clique para: Excluir"></a></td>
  ...
  <tr>
    <td>
	<form action="app_usuario_grupo_edit.php?id=<?=$ID?>" method="post" name="frm" id="frm" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Sigla:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmSigla" id="FrmSigla" class="frm"  size="5" maxlength="5" value="<?=$frm_sigla?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Tipo:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
            <select name="FrmTipo" class="frm" id="FrmTipo">
            	<option value="1" <? if($frm_tipo == 1){print('selected="selected"');}?>>Usuário de Sistema</option>
                <option value="0" <? if($frm_tipo == 0){print('selected="selected"');}?>>Usuário da Administração</option>
            </select>
          </td>
        </tr>
        <tr>
          ...
          <td bgcolor="#CCCCCC" style="padding:3px 3px 3px 3px">
           ...
           <input type="button" name="btCancelar" id="btCancelar" class="frm_botao" value="Cancelar/Voltar" onclick="javascript:window.open('app_usuario_grupo_list.php', '_parent')" <?=$label_alerta_status?>>
		  </td>
        </tr>
      </table>
    </form>
