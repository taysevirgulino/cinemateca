<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("curriculo_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Currículo: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <? } ?>
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmIdCurriculoArea">&nbsp;Currículo Área: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
    ...
    <? } ?>
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmIdCurriculoSegmento">&nbsp;Currículo Segmento: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	...
          	<? if(!empty($frm_imagem)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:5px 0px 0px 0px;">
          			<img src="../images/curriculo/<?=$frm_imagem?>" style="position:relative; float:left; margin:0px 5px 5px 0px;" />
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="file" name="FrmArquivoFile" id="FrmArquivoFile" class="frm" size="60" maxlength="255" value="">          	<? if(!empty($frm_arquivo)){ ?>
          		<div style="position:relative; float:left; width:100%; margin:5px 0px 0px 0px;">
          			<a href="../files/curriculo/<?=$frm_arquivo?>" target="_blank" style="text-decoration:underline;"><?=$frm_arquivo?></a>
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmIdCurriculoArea':{'l':' Currículo Área','t':'labelFrmIdCurriculoArea','r':true},
            'FrmIdCurriculoSegmento':{'l':' Currículo Segmento','t':'labelFrmIdCurriculoSegmento','r':true},
