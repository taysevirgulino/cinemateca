<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("site_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Site: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmEmailNome">&nbsp;E-mail Nome: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmEmailNome" id="FrmEmailNome" class="frm" size="80" maxlength="255" value="<?=$frm_email_nome?>">
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmHost">&nbsp;Host: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmHost" id="FrmHost" class="frm" size="80" maxlength="255" value="<?=$frm_host?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmTemplate">&nbsp;Template: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmTemplate" id="FrmTemplate" class="frm" size="80" maxlength="255" value="<?=$frm_template?>">
          </td>
        </tr>
        <!--<tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmImagemTopo">&nbsp;Imagem Topo: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="file" name="FrmImagemTopoFile" id="FrmImagemTopoFile" class="frm" size="60" maxlength="255" value="">
          </td>
        </tr>-->
        <tr>
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Grupos: </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          <?
				$ct = AppUsuarioGrupoManage::consultarAppUsuarioGrupoAttribute("", "", "", AppUsuarioGrupoAttribute::Nome(), SearchOrder::Crescente());
				$cont = 0;
				for($j=0; $j < count($ct); $j++){
					$checked = "";
					for($h=0; $h < count($vgrupos); $h++){
						if($vgrupos[$h] == $ct[$j]["id_app_usuario_grupo"]){
							$checked = 'checked="checked"';
						}
					}
					print('<input type="checkbox" name="rbGrupo'.$cont.'" value="'.$ct[$j]["id_app_usuario_grupo"].'" '.$checked.' /><span  style="font-weight:normal;">'.$ct[$j]["nome"].'</span><br />');
					$cont++;
				}
				print('<input name="qtdGrupos" type="hidden" id="qtdGrupos" value="'.$cont.'" />');
		  ?>
          </td>
        </tr>
        <tr>
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmEmailNome':{'l':' E-mail Nome','t':'labelFrmEmailNome','r':true},
            'FrmUrl':{'l':' Url (Endereço)','t':'labelFrmUrl','r':true},
            'FrmHost':{'l':' Host','t':'labelFrmHost','r':true},
            'FrmTemplate':{'l':' Template','t':'labelFrmTemplate','r':true},
