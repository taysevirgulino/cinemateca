<?
	...
	$objPHPExcel->getActiveSheet()->setCellValue("A1", utf8_encode("Código Currículo"));
	...
	$objPHPExcel->getActiveSheet()->setCellValue("D1", utf8_encode("Currículo Área"));
	$objPHPExcel->getActiveSheet()->getStyle("D1")->applyFromArray($styleTitulo);
	$objPHPExcel->getActiveSheet()->getColumnDimension("D")->setAutoSize(true);

	$objPHPExcel->getActiveSheet()->setCellValue("E1", utf8_encode("Currículo Segmento"));
