<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("audio_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Áudio: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
            ...
            <? if(!empty($frm_imagem)){ ?><p><img src="../images/audio/A<?=$frm_imagem?>" /></p><? } ?>
          </td>
        </tr>
        <tr>
