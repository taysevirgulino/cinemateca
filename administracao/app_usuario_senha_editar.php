<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("app_usuario_senha_editar.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo">Alterar Senha </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><form action="app_usuario_senha_editar.php" method="post" name="frm" id="frm">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td width="176" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp;Senha Atual: * </td>
          <td width="365" bgcolor="#F2F2F2"><table width="100%"  border="0" cellspacing="3" cellpadding="0">
            <tr>
              <td><input name="txtSenhaAtual" type="password" class="frm" id="txtSenhaAtual" size="15" maxlength="15"></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp;Senha Nova: * </td>
          <td bgcolor="#F2F2F2"><table width="100%"  border="0" cellspacing="3" cellpadding="0">
            <tr>
              <td><input name="txtSenhaNova" type="password" class="frm" id="txtSenhaNova" size="15" maxlength="15"></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp;Confirmar Senha Nova: * </td>
          <td bgcolor="#F2F2F2"><table width="100%"  border="0" cellspacing="3" cellpadding="0">
            <tr>
              <td><input name="txtSenhaNovaConf" type="password" class="frm" id="txtSenhaNovaConf" size="15" maxlength="15"></td>
            </tr>
          </table></td>
        </tr>
        <tr>
