<?
	...
	$vobjCount = SearchMysqlQuery::CountBySql( SearchMounter::MounterByQueryCount(EmktDestinatarioAttribute::_Table(), $SearchQueryComparerCollection) );
	...
	$vobj = EmktDestinatarioManage::consultarEmktDestinatario(3, SearchMounter::MounterByQueryLimit(EmktDestinatarioAttribute::_Table(), $SearchQueryComparerCollection, $SearchQueryOrderCollection, $paginacao->getPaginacaoInicio(), $paginacao->getRegistrosPorPagina()));

	$Orders = SearchOrder::_GetAllOrders();
	$Comparers = SearchComparer::_GetAllComparers();
	$Attributes = EmktDestinatarioAttribute::_GetAllAttributes();
?>