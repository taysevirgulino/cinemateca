<?
	...
	$vobj = GaleriaAlbumManage::consultarGaleriaAlbum(3, SearchMounter::MounterByQueryComparerOrder(GaleriaAlbumAttribute::_Table(), $export["SearchQueryComparerCollection"], $export["SearchQueryOrderCollection"]));

	$objPHPExcel = new PHPExcel();
	$objPHPExcel->getProperties()->setCreator("ArtemSite")
								 ->setLastModifiedBy("ArtemSite")
								 ->setTitle("Dados GaleriaAlbum")
								 ->setSubject("Dados GaleriaAlbum")
								 ->setDescription("Dados GaleriaAlbum")
								 ->setKeywords("Dados GaleriaAlbum")
								 ->setCategory("GaleriaAlbum");
	...
	$objPHPExcel->getActiveSheet()->setCellValue("A1", utf8_encode("Código Galeria Álbum"));
	...
	$objPHPExcel->getActiveSheet()->setCellValue("C1", utf8_encode("Galeria Categoria"));
	...
	for ($i = 0; $i < count($vobj); $i++) {
		$objPHPExcel->getActiveSheet()->setCellValue("A".($i+2), utf8_encode($vobj[$i]["id_galeria_album"]));
	...
	$fileName = "GaleriaAlbum_".date("d-m-Y_H-i-s").".xlsx";
