<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("associado_plano_edit.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Associado Plano: Edi&ccedil;&atilde;o </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="<?=$link_edit?>" method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmValor">&nbsp;Valor:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmValor" id="FrmValor" class="frm" size="9" maxlength="9" value="<?=$frm_valor?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmProrata">&nbsp;Prorata:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmProrata" id="FrmProrata" class="frm" size="11" maxlength="11" value="<?=$frm_prorata?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmRecorrencia">&nbsp;Recorrencia:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmRecorrencia" id="FrmRecorrencia" class="frm" size="11" maxlength="11" value="<?=$frm_recorrencia?>">
          </td>
        </tr>
        <tr>
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmValor':{'l':' Valor','t':'labelFrmValor'},
            'FrmProrata':{'l':' Prorata','t':'labelFrmProrata'},
            'FrmRecorrencia':{'l':' Recorrencia','t':'labelFrmRecorrencia'},
