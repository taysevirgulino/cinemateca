...
var CodeMirror = (function(){
  ...
  CodeMirror.prototype = {
    ...
    getSearchProdutor: function(string, fromProdutor, caseFold) {
      return this.editor.getSearchProdutor(string, fromProdutor, caseFold);
    },
    ...
    produtorPosition: function(start) {this.focusIfIE(); return this.editor.produtorPosition(start);},
    ...
    currentLine: function() {
      return this.lineNumber(this.produtorPosition().line);
    },
