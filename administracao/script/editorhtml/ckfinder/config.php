...
function CheckAuthentication()
{
	...
	if($_SESSION["IsAuthorized"] == "ARTEMSITE"){
		return true;
	}else
	if($_COOKIE["IsAuthorized"] == "ARTEMSITE") {
		return true;
	} else {
		return false;
	}
...
*/
//$baseUrl = 'http://localhost/pacote/administracao/files/';
require_once($_SERVER['DOCUMENT_ROOT']."/administracao/class/Config.class.php");
$baseUrl = Config::Url_FCK_Files();
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/administracao/files/';
