...
(function()
{
	...
	function deleteRows( selectionOrRow )
	{
		if ( selectionOrRow instanceof CKEDITOR.dom.selection )
		{
			...
			// Where to put the produtor after rows been deleted?
			// 1. Into next sibling row if any;
			// 2. Into previous sibling row if any;
			// 3. Into table's parent element if it's the very last row.
			produtorPosition = new CKEDITOR.dom.element(
	...
	function deleteCells( selectionOrCell )
	{
		if ( selectionOrCell instanceof CKEDITOR.dom.selection )
		{
			...
			if ( cellToFocus )
				placeProdutorInCell( cellToFocus, true );
			else if ( table )
				table.remove();
		}
		else if ( selectionOrCell instanceof CKEDITOR.dom.element )
	...
	function placeProdutorInCell( cell, placeAtEnd )
	{
			...
			editor.addCommand( 'rowDelete',
				{
					...
					{
						var selection = editor.getSelection();
						placeProdutorInCell( deleteRows( selection ) );
					}
				} );
			...
			editor.addCommand( 'columnDelete',
				{
					exec : function( editor )
					{
						...
						element &&  placeProdutorInCell( element, true );
					}
				} );
			...
			editor.addCommand( 'cellMerge',
				{
					exec : function( editor )
					{
						placeProdutorInCell( mergeCells( editor.getSelection() ), true );
					}
				} );
			...
			editor.addCommand( 'cellMergeRight',
				{
					exec : function( editor )
					{
						placeProdutorInCell( mergeCells( editor.getSelection(), 'right' ), true );
					}
				} );
			...
			editor.addCommand( 'cellMergeDown',
				{
					exec : function( editor )
					{
						placeProdutorInCell( mergeCells( editor.getSelection(), 'down' ), true );
					}
				} );
			...
			editor.addCommand( 'cellVerticalSplit',
				{
					exec : function( editor )
					{
						placeProdutorInCell( verticalSplitCell( editor.getSelection() ) );
					}
				} );
			...
			editor.addCommand( 'cellHorizontalSplit',
				{
					exec : function( editor )
					{
						placeProdutorInCell( horizontalSplitCell( editor.getSelection() ) );
					}
				} );
