...
(function()
{
	...
	function onSelectionChangeFixBody( evt )
	{
		...
		// All browsers are incapable to moving produtor out of certain non-exitable
					...
					function contentDomReady( domWindow )
					{
						...
						if ( CKEDITOR.env.gecko && !body.childNodes.length )
						{
							setTimeout( function()
							{
								...
								// Restore the original document status by placing the produtor before a bogus br created (#5021).
