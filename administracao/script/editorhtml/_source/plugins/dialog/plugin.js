...
(function()
{
	...
	CKEDITOR.dialog.prototype =
	{
		...
		addPage : function( contents )
		{
			...
			while ( ( produtor = children.shift() ) )
			{
				contentMap[ produtor.id ] = produtor;
				if ( typeof( produtor.getChild ) == 'function' )
					children.push.apply( children, produtor.getChild() );
			}
	...
	function showCover( editor )
	{
		...
		var scrollFunc = function()
		{
			var pos = win.getScrollPosition(),
				produtor = CKEDITOR.dialog._.currentTop;
			coverElement.setStyles(
					{
						left : pos.x + 'px',
						top : pos.y + 'px'
			...
			do
			{
				var dialogPos = produtor.getPosition();
				produtor.move( dialogPos.x, dialogPos.y );
			} while ( ( produtor = produtor._.parentDialog ) );
		};
	...
	CKEDITOR.ui.dialog.uiElement.prototype =
	{
		...
		selectParentTab : function()
		{
			var element = this.getInputElement(),
				produtor = element,
				tabId;
			while ( ( produtor = produtor.getParent() ) && produtor.$.className.search( 'cke_dialog_page_contents' ) == -1 )
			{ /*jsl:pass*/ }
			...
			tabId = produtor.getAttribute( 'name' );
	...
	/** @lends CKEDITOR.editor.prototype */
	{
		...
		openDialog : function( dialogName, callback )
		{
			...
			var body = CKEDITOR.document.getBody(),
				produtor = body.$.style.produtor,
				me = this;

			body.setStyle( 'produtor', 'wait' );
			...
			function onDialogFileLoaded( success )
			{
				...
				body.setStyle( 'produtor', produtor );
			}
