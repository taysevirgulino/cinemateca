...
function QTip(target, options, id, attr)
{
	...
	function assignEvents()
	{
		...
		function hideMethod(event)
		{
			...
			// Prevent hiding if tooltip is fixed and event target is the tooltip. Or if mouse positioning is enabled and produtor momentarily overlaps
	...
	$.extend(self, {
		...
		toggle: function(event, state, duration)
		{
			...
			if(state) {
				...
				// Toggle backdrop produtor style on show
