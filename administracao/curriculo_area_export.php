<?
	...
	$vobj = CurriculoAreaManage::consultarCurriculoArea(3, SearchMounter::MounterByQueryComparerOrder(CurriculoAreaAttribute::_Table(), $export["SearchQueryComparerCollection"], $export["SearchQueryOrderCollection"]));

	$objPHPExcel = new PHPExcel();
	$objPHPExcel->getProperties()->setCreator("ArtemSite")
								 ->setLastModifiedBy("ArtemSite")
								 ->setTitle("Dados CurriculoArea")
								 ->setSubject("Dados CurriculoArea")
								 ->setDescription("Dados CurriculoArea")
								 ->setKeywords("Dados CurriculoArea")
								 ->setCategory("CurriculoArea");
	...
	$objPHPExcel->getActiveSheet()->setCellValue("A1", utf8_encode("Código Currículo Área"));
	...
	for ($i = 0; $i < count($vobj); $i++) {
		$objPHPExcel->getActiveSheet()->setCellValue("A".($i+2), utf8_encode($vobj[$i]["id_curriculo_area"]));
	...
	$fileName = "CurriculoArea_".date("d-m-Y_H-i-s").".xlsx";
