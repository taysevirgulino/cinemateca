<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("fale_conosco_assunto_add.inc.php"); require_once("script/editorhtml/ckeditor.php");?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Fale Conosco Assunto: Cadastro </td>
  </tr>
  <tr>
  ...
  <tr>
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmAssunto" id="FrmAssunto" class="frm" size="80" maxlength="100" value="<?=$frm_assunto?>">
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmEmails">&nbsp;E-mails:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<input type="text" name="FrmEmails" id="FrmEmails" class="frm" size="80" maxlength="255" value="<?=$frm_emails?>"><br />
            <span class="frm_exemplo">Exemplo: joao@empresa.com.br; maria@empresa.com.br (se for mais de um e-mail separar por ;)</span>
          </td>
        </tr>
        <tr>
    ...
    <!--
        ...
        var a_fields = {
            ...
            'FrmEmails':{'l':' E-mails','t':'labelFrmEmails'},
