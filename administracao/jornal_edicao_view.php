<? require_once("config.inc.php"); require_once("logon.inc.php"); require_once("jornal_edicao_view.inc.php"); ?>
<?
	require_once("layout_sup.php");
?>
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" class="texto_titulo"> Revista Edição: Visualização </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<table width="97" border="0" align="right" cellpadding="0" cellspacing="2">
      <tr>
        ...
        <td width="23"><a href="<?=$link_edit?>"><img src="images/botao/btn_edit_over.gif" width="22" height="21" border="0" alt="Clique para: Editar"></a></td>
  ...
  <tr>
	...
	<form action="" method="post" name="frm" id="frm">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Ano: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?=$frm_ano?>
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Data Inicial: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?=$frm_data_inicial?>
          </td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto">&nbsp; Data Final: * </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?=$frm_data_final?>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
          	<?
				$Pagina = JornalPaginaManage::PaginaByEdicaoEstrutura($ID, $VObjJornalEstrutura[$i][0]);
            	if(!empty($Pagina)){
					print('<img src="../images/jornal_pagina/A'.$Pagina["imagem"].'" />');
				}
			?>
          </td>
        </tr>
