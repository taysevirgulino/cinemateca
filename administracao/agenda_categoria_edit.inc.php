<?
	...
	if(!$obj->buscarAgendaCategoria(1, $ID)){ System::Redirect($link_list); }
	...
	if ( ! Validacao::isVazio($frm_bt) ){
		...
		if( Validacao::isVazio($label_alerta_erro) ){
			if(AgendaCategoriaManage::alterarAgendaCategoria($ID, null, null, $frm_nome, $frm_descricao, $frm_prioridade)){
