...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form action="" method="post" name="frm" id="frm" enctype="multipart/form-data" onSubmit="return _Validar();">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td height="25" colspan="2" class="frm_texto">Informações para todas fotos (opcional):</td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmCredito">&nbsp;Título/Crédito:  </td>
        ...
        <tr>
          ...
          <td bgcolor="#CCCCCC" style="padding:3px 3px 3px 3px">
          	<input type="submit" name="btSubmit" id="btSubmit" class="frm_botao" value="Próximo >" <?=$label_alerta_status?>>
		  </td>
        </tr>
      </table>
    </form>
  ...
  <tr>
	...
	<form action="galeria_foto_upload.php" method="post" name="frm" id="frm" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="3" cellpadding="0">
        <tr>
          <td height="25" colspan="2" class="frm_texto">1) Informações para todas fotos (opcional):</td>
        </tr>
        <tr>
          <td width="25%" height="25" bgcolor="#CCCCCC" class="frm_texto" id="labelFrmCredito">&nbsp;Título/Crédito:  </td>
          <td width="75%" bgcolor="#F2F2F2" style="padding:3px 3px 3px 3px">
        ...
        <tr>
          <td height="25" colspan="2" class="frm_texto">2) Upload de Imagens: <span style="font-weight:normal">(formatos válidos: .jpg ou .gif)</span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="25" colspan="2" bgcolor="#FFFFFF">
          	<span style="color:#FF0000;">
	            É necessário ter instalado o plugin do <strong>Java</strong>, caso não tenha, <a href="http://www.java.com/pt_BR/" target="_blank" style="color:#FF0000; text-decoration:underline;">clique aqui para instalar.</a>
            </span>
          </td>
        </tr>
      </table>
