<?php /* Smarty version Smarty-3.1.8, created on 2015-04-13 19:55:02
         compiled from "/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/default/html/mensagem_view.tpl.php" */ ?>
<?php /*%%SmartyHeaderCode:2300974825529d711d7c0a9-46031291%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '22ff3ebdf7faaff396b4c7f1992e54f46cd8e553' => 
    array (
      0 => '/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/default/html/mensagem_view.tpl.php',
      1 => 1428806477,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2300974825529d711d7c0a9-46031291',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5529d7126b7131_80828329',
  'variables' => 
  array (
    'CONFIG' => 0,
    'TITLE' => 0,
...
<?php if ($_valid && !is_callable('content_5529d7126b7131_80828329')) {function content_5529d7126b7131_80828329($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/_smarty/libs/plugins/modifier.truncate.php';
...
<div class="row" style="padding-bottom:20px;">
	<div class="col-md-2  col-md-offset-10">
		<a href="<?php echo $_smarty_tpl->tpl_vars['URL_PATH']->value;?>
mensagem-list" class="btn btn-sm btn-default btn-block">
...
<div class="row">
	<div class="col-md-12">
		<h3>Informações Mensagem #<?php echo $_smarty_tpl->tpl_vars['obj']->value->getIdMensagem();?>
</h3>
		<hr />
		<div class="row" style="margin-top:15px;">
			<div class="col-md-6" style="width:auto"><strong><i class="fa fa-user"></i> Remetente:</strong> <?php echo $_smarty_tpl->tpl_vars['objUsuarioRemetente']->value->getNome();?>
</div>
			<div class="col-md-6" style="width:auto"><strong><i class="fa fa-user"></i> Destinatário:</strong> <?php echo $_smarty_tpl->tpl_vars['objUsuarioDestinatario']->value->getNome();?>
</div>
		</div>
		<div class="row" style="margin-top:15px;">
			<div class="col-md-4" style="width:auto"><strong><i class="fa fa-clock-o"></i> Cadastro:</strong> <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['obj']->value->getDatahora(),"%d.%m.%y %Hh%M");?>
</div>
			<div class="col-md-4" style="width:auto"><strong><i class="fa fa-clock-o"></i> Última resposta:</strong> <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['obj']->value->getDatahoraEdicao(),"%d.%m.%y %Hh%M");?>
</div>
		</div>
		<div class="row" style="margin-top:15px;">
			<div class="col-md-8" style="width:auto"><strong><i class="fa fa-list-alt"></i> Assunto:</strong> <?php echo $_smarty_tpl->tpl_vars['obj']->value->getTitulo();?>
</div>
			<div class="col-md-3" style="width:auto"><strong><i class="fa fa-list-alt"></i> Situação:</strong> <?php echo $_smarty_tpl->tpl_vars['status']->value['span'];?>
</div>
		</div>
		<div class="row" style="margin-top:15px;">
			<div class="col-md-12">
				<hr />
				<?php echo $_smarty_tpl->tpl_vars['obj']->value->getTexto();?>

			</div>
			<?php if ($_smarty_tpl->tpl_vars['obj']->value->getArquivo()!=''){?>
			<div class="col-md-12" style="margin-top:15px;">
				<a href="<?php echo $_smarty_tpl->tpl_vars['URL_PATH']->value;?>
files/mensagem/<?php echo $_smarty_tpl->tpl_vars['obj']->value->getArquivo();?>
" target="_blank" title="Clique para baixar"><i class="icon-li fa fa-download"></i> <?php echo $_smarty_tpl->tpl_vars['obj']->value->getArquivo();?>
	...
	<div class="col-md-12" style="margin-top:40px;">
		<h3>Interações <a href="<?php echo $_smarty_tpl->tpl_vars['URL_PATH']->value;?>
mensagem-reply-<?php echo $_smarty_tpl->tpl_vars['obj']->value->getIdentificador();?>
" class="btn btn-secondary pull-right"><i class="fa fa-comment"></i> &nbsp;Responder/Atualizar</a></h3>
		...
		<div class="table-responsive">
			<table class="table table-striped" style="width:100%">
				<tbody>
					<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['itensMensagemHistorico']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
					<tr>
						...
						<td style="width: 80%">
							<p><strong><i class="fa fa-user"></i> Usuário:</strong> <?php echo $_smarty_tpl->tpl_vars['item']->value['nome'];?>
 (<?php echo $_smarty_tpl->tpl_vars['item']->value['email'];?>
)</p>
							<p><?php echo $_smarty_tpl->tpl_vars['item']->value['texto'];?>
</p>
							<?php if ($_smarty_tpl->tpl_vars['item']->value['arquivo']!="arquivo"){?>
								<p>
									<u>ANEXO:</u>
								</p>
								<p>
									<a href="<?php echo $_smarty_tpl->tpl_vars['URL_PATH']->value;?>
files/mensagem/<?php echo $_smarty_tpl->tpl_vars['item']->value['arquivo'];?>
" target="_blank" title="Clique para baixar"><i class="icon-li fa fa-download"></i> <?php echo $_smarty_tpl->tpl_vars['item']->value['arquivo'];?>
</a>
								</p>
							<?php }?>
						</td>
...
images/usuario/A<?php if ($_smarty_tpl->tpl_vars['item']->value['imagem']!=''){?><?php echo $_smarty_tpl->tpl_vars['item']->value['imagem'];?>
<?php }else{ ?>null.jpg<?php }?>" alt="<?php echo $_smarty_tpl->tpl_vars['item']->value['nome'];?>
" /> </div></td>
					</tr>
					<?php } ?>
				</tbody>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("analytics.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '2300974825529d711d7c0a9-46031291');
content_552c4947a49694_31336146($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "analytics.tpl.php" */?>
</body>

</html><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-04-13 19:55:03
         compiled from "/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/default/html/analytics.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_552c4947a49694_31336146')) {function content_552c4947a49694_31336146($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['analytics_key']!=''){?>
