<?php /* Smarty version Smarty-3.1.8, created on 2018-06-06 21:43:19
         compiled from "C:\www\Cinemateca/template/default/html\eixo_edit.tpl.php" */ ?>
<?php /*%%SmartyHeaderCode:326905b187e9a678859-34040259%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c2386f8c2db10287daf38b21d60a547963b37b4' => 
    array (
      0 => 'C:\\www\\Cinemateca/template/default/html\\eixo_edit.tpl.php',
      1 => 1528331422,
      2 => 'file',
    ),
    ...
    'de222c34e2b4908aa3dea967b818c1536319b5e5' => 
    array (
      0 => 'C:\\www\\Cinemateca/template/default/html\\eixo_form.tpl.php',
      1 => 1528332198,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '326905b187e9a678859-34040259',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5b187e9ac66951_69778897',
  'variables' => 
  array (
    'CONFIG' => 0,
    'TITLE' => 0,
...
<?php if ($_valid && !is_callable('content_5b187e9ac66951_69778897')) {function content_5b187e9ac66951_69778897($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\www\\Cinemateca/template/_smarty/libs/plugins\\modifier.date_format.php';
?><!DOCTYPE html>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("form_alert.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '326905b187e9a678859-34040259');
content_5b187fa7a75536_12402317($_smarty_tpl);
...
<div class="portlet">
	...
	<?php /*  Call merged included template "eixo_form.tpl.php" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("eixo_form.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '326905b187e9a678859-34040259');
content_5b187fa7af63c8_74559226($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "eixo_form.tpl.php" */?>
...
form.js"></script>
	<script type="application/javascript">
		$(function(){
			//$("#FrmIdEixoCategoria").val( "<?php echo $_smarty_tpl->tpl_vars['obj']->value->getIdEixoCategoria();?>
" );
			$("#FrmNome").val( "<?php echo $_smarty_tpl->tpl_vars['obj']->value->getNome();?>
" );
			$('#FrmIdDisciplina').val(('<?php echo $_smarty_tpl->tpl_vars['obj']->value->getIdDisciplina();?>
')); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("analytics.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '326905b187e9a678859-34040259');
content_5b187fa7caa6d3_25826142($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "analytics.tpl.php" */?>
</body>

</html><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2018-06-06 21:43:19
         compiled from "C:\www\Cinemateca/template/default/html\form_alert.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_5b187fa7a75536_12402317')) {function content_5b187fa7a75536_12402317($_smarty_tpl) {?><div class="row">
	<div class="col-sm-12">
...
</div><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2018-06-06 21:43:19
         compiled from "C:\www\Cinemateca/template/default/html\eixo_form.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_5b187fa7af63c8_74559226')) {function content_5b187fa7af63c8_74559226($_smarty_tpl) {?><form id="frm" name="frm" action="" class="parsley-form" enctype="multipart/form-data" method="post" data-parsley-validate data-parsley-excluded="input.excluded">
	...
	<div class="row">
		...
		<!-- <div class="col-sm-6">
			<div class="form-group">
				...
				<select id="FrmIdEixoCategoria" name="FrmIdEixoCategoria" class="form-control" ><option value=""></option><?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['itensEixoCategoria']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?><option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['id_eixo_categoria'];?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value['nome'];?>
		...
		<div class="col-sm-12">
			<div class="form-group">
				...
				<select id="FrmIdDisciplina" name="FrmIdDisciplina" class="form-control selectpicker" multiple data-actions-box="true" ><option value=""></option><?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['itensDisciplina']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?><option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['id_disciplina'];?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value['nome'];?>
</option><?php } ?></select>
			</div>
		</div>
...
<!-- /.portlet-content --> 
</form><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2018-06-06 21:43:19
         compiled from "C:\www\Cinemateca/template/default/html\analytics.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_5b187fa7caa6d3_25826142')) {function content_5b187fa7caa6d3_25826142($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['analytics_key']!=''){?>
