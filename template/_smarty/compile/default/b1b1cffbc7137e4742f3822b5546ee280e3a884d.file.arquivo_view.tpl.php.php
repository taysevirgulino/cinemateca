<?php /* Smarty version Smarty-3.1.8, created on 2015-04-14 11:00:50
         compiled from "/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/default/html/arquivo_view.tpl.php" */ ?>
<?php /*%%SmartyHeaderCode:1006887455297285132825-88557085%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b1b1cffbc7137e4742f3822b5546ee280e3a884d' => 
    array (
      0 => '/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/default/html/arquivo_view.tpl.php',
      1 => 1428790091,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1006887455297285132825-88557085',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_55297285784446_73945820',
  'variables' => 
  array (
    'CONFIG' => 0,
    'TITLE' => 0,
...
<?php if ($_valid && !is_callable('content_55297285784446_73945820')) {function content_55297285784446_73945820($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/_smarty/libs/plugins/modifier.truncate.php';
...
<div class="row">
	<div class="col-md-12">
		<h3>Informações Arquivo/Protocolo #<?php echo $_smarty_tpl->tpl_vars['obj']->value->getIdArquivo();?>
</h3>
		<hr />
		<div class="row">
		...
		<div class="row" style="margin-top:15px;">
			<div class="col-md-6" style="width:auto"><strong><i class="fa fa-user"></i> Usuário (cadastro):</strong> <?php echo $_smarty_tpl->tpl_vars['objUsuario']->value->getNome();?>
</div>
			<div class="col-md-6" style="width:auto"><strong><i class="fa fa-user"></i> Responsável (responder):</strong> <?php echo $_smarty_tpl->tpl_vars['objUsuarioResponsavel']->value->getNome();?>
</div>
		</div>
		<div class="row" style="margin-top:15px;">
			...
			<div class="col-md-4"><strong><i class="fa fa-clock-o"></i> Última resposta:</strong> <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['obj']->value->getDatahoraEdicao(),"%d.%m.%y %Hh%M");?>
</div>
		</div>
		<div class="row" style="margin-top:15px;">
			<div class="col-md-8"><strong><i class="fa fa-list-alt"></i> Assunto:</strong> <?php echo $_smarty_tpl->tpl_vars['obj']->value->getTitulo();?>
</div>
			<div class="col-md-3"><strong><i class="fa fa-list-alt"></i> Situação:</strong> <?php echo $_smarty_tpl->tpl_vars['status']->value;?>
</div>
		</div>
	</div>
...
?>
					<tr>
						...
						<td style="width: 80%">
							<p><strong><i class="fa fa-user"></i> Usuário:</strong> <?php echo $_smarty_tpl->tpl_vars['item']->value['usuario_nome'];?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("analytics.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1006887455297285132825-88557085');
content_552d1d92d92971_68311786($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "analytics.tpl.php" */?>
</body>

</html><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-04-14 11:00:50
         compiled from "/Cloud/Sites/brmalls.com.br/sal.brmalls.com.br/www/template/default/html/analytics.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_552d1d92d92971_68311786')) {function content_552d1d92d92971_68311786($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['analytics_key']!=''){?>
