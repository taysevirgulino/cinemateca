<?php /* Smarty version Smarty-3.1.8, created on 2014-11-12 15:38:51
         compiled from "/Cloud/Sites/sal.brmalls.com.br/sal.brmalls.com.br/www/template/default/html/index.tpl.php" */ ?>
<?php /*%%SmartyHeaderCode:14249690205461f4bb0ec4e1-77544770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ce5dcc77c1bda69f08fa6e7aa2100c924052cabc' => 
    array (
    ...
    '12cec5a5bb97c655ad9b4b89e87481d6bf2dc4d0' => 
    array (
      0 => '/Cloud/Sites/sal.brmalls.com.br/sal.brmalls.com.br/www/template/default/html/index_classificados.tpl.php',
      1 => 1415734017,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '14249690205461f4bb0ec4e1-77544770',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5461f4bb7c2e73_24149615',
  'variables' => 
  array (
    'CONFIG' => 0,
    'TITLE' => 0,
...
<?php if ($_valid && !is_callable('content_5461f4bb7c2e73_24149615')) {function content_5461f4bb7c2e73_24149615($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Cloud/Sites/sal.brmalls.com.br/sal.brmalls.com.br/www/template/_smarty/libs/plugins/modifier.date_format.php';
...
<article class="full-width add-bottom add-top bt">
	<div class="container">
		<div class="bloco half-top isotope" id="filter-container">
			
			<div class="element-item width2 height3">
				<div class="flexslider wd1">
					<ul class="slides">
						<?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['n']->_loop = false;
 $_smarty_tpl->tpl_vars['Key'] = new Smarty_Variable;
...
$_smarty_tpl->tpl_vars['n']->_loop = true;
 $_smarty_tpl->tpl_vars['Key']->value = $_smarty_tpl->tpl_vars['n']->key;
?>
						<li class="noticia"><a href="<?php echo $_smarty_tpl->tpl_vars['n']->value['url'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['n']->value['titulo'];?>
">
							<img src="<?php echo $_smarty_tpl->tpl_vars['n']->value['foto_area_publicacao'];?>
" width="460" height="350" alt="<?php echo $_smarty_tpl->tpl_vars['n']->value['titulo'];?>
" />
							<div class="slider_texto">
								<span class="relative"><?php echo $_smarty_tpl->tpl_vars['n']->value['chapeu'];?>
</span>
								<h3 class="bloco"><?php echo $_smarty_tpl->tpl_vars['n']->value['titulo'];?>
</h3>
							</div>
						</a></li>
						<?php } ?>
			...
			<?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['n']->_loop = false;
 $_smarty_tpl->tpl_vars['Key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['N']->value['A1416257896']['Noticias']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['n']->key => $_smarty_tpl->tpl_vars['n']->value){
$_smarty_tpl->tpl_vars['n']->_loop = true;
 $_smarty_tpl->tpl_vars['Key']->value = $_smarty_tpl->tpl_vars['n']->key;
?>
...
<section class="full-width">
	<div class="container">
		<div class="one-third column">
			<div class="publicidade_b add-top">
				<?php echo $_smarty_tpl->tpl_vars['Banner']->value['LocalCE01'];?>
		...
		<div class="one-third column">
			<div class="publicidade_b add-top">
				<?php echo $_smarty_tpl->tpl_vars['Banner']->value['LocalCE02'];?>
		...
		<div class="one-third column">
			<div class="publicidade_b add-top">
				<?php echo $_smarty_tpl->tpl_vars['Banner']->value['LocalCE03'];?>
...
<section class="full-width add-bottom add-top">
	<div class="container">
		<div class="bloco half-top isotope" id="filter-container">
			...
			<?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['n']->_loop = false;
 $_smarty_tpl->tpl_vars['Key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['N']->value['A1415980263']['Noticias']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['n']->key => $_smarty_tpl->tpl_vars['n']->value){
$_smarty_tpl->tpl_vars['n']->_loop = true;
 $_smarty_tpl->tpl_vars['Key']->value = $_smarty_tpl->tpl_vars['n']->key;
?>
			<div class="element-item width2 height2 n_destaque">
				<a href="<?php echo $_smarty_tpl->tpl_vars['n']->value['url'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['n']->value['titulo'];?>
" class="noticia relative">
					<div class="bloco texto_b">
			...
			<?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['n']->_loop = false;
 $_smarty_tpl->tpl_vars['Key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['N']->value['A1422772565']['Noticias']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['n']->key => $_smarty_tpl->tpl_vars['n']->value){
$_smarty_tpl->tpl_vars['n']->_loop = true;
 $_smarty_tpl->tpl_vars['Key']->value = $_smarty_tpl->tpl_vars['n']->key;
?>
...
<section class="full-width">
	<div class="container">
		<div class="two-thirds column">
			<div class="publicidade_b publicidade_b2 add-top">
				<?php echo $_smarty_tpl->tpl_vars['Banner']->value['LocalCE04'];?>
		...
		<div class="one-third column">
			<div class="publicidade_b add-top">
				<?php echo $_smarty_tpl->tpl_vars['Banner']->value['LocalCE05'];?>
...
<section class="full-width add-bottom add-top">
	<div class="container">
		<div class="eight columns add-top">
			<div class="bloco">
				<h2 class="relative t1"><a href="<?php echo $_smarty_tpl->tpl_vars['Url']->value['Videos'];?>
" title="Vídeos">Vídeos</a></h2>
				<a href="<?php echo $_smarty_tpl->tpl_vars['Url']->value['Videos'];?>
" class="relative right ver_mais" title="Ver Todos">Ver Todos</a>
			</div>
			<div class="bloco half-top isotope isotope2" id="filter-container">
...
?>
				<div class="element-item" style="height:248px; overflow:hidden">
					<a href="<?php echo $_smarty_tpl->tpl_vars['v']->value['url'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['v']->value['titulo'];?>
" class="noticia relative">
						<img src="<?php echo $_smarty_tpl->tpl_vars['v']->value['thumb2'];?>
" width="220" height="165" alt="<?php echo $_smarty_tpl->tpl_vars['v']->value['titulo'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['v']->value['titulo'];?>
">
						<div class="bloco texto_b">
							<span><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['datahora'],"%d.%m.%y");?>
</span>
		...
		<div class="eight columns add-top">
			<div class="bloco">
				<h2 class="relative t1"><a href="<?php echo $_smarty_tpl->tpl_vars['Url']->value['GaleriaFotos'];?>
" title="Vídeos">Galeria de Fotos</a></h2>
				<a href="<?php echo $_smarty_tpl->tpl_vars['Url']->value['GaleriaFotos'];?>
" class="relative right ver_mais" title="Ver Todos">Ver Todos</a>
			</div>
			<div class="bloco half-top isotope isotope2" id="filter-container">
				<?php  $_smarty_tpl->tpl_vars['a'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['a']->_loop = false;
 $_smarty_tpl->tpl_vars['Key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['Albuns']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" title="<?php echo $_smarty_tpl->tpl_vars['a']->value['nome'];?>
" class="noticia relative">
						<img src="<?php echo $_smarty_tpl->tpl_vars['URL_PATH']->value;?>
images/galeria/A<?php echo $_smarty_tpl->tpl_vars['a']->value['Foto']['foto'];?>
" width="220" height="147" alt="<?php echo $_smarty_tpl->tpl_vars['a']->value['nome'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['a']->value['nome'];?>
">
						<div class="bloco texto_b">
							<span><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['a']->value['datahora'],"%d.%m.%y");?>
</span>
							<h4><?php echo $_smarty_tpl->tpl_vars['a']->value['nome'];?>
</h4>
						</div>
					</a>
				</div>
...
<?php /*  Call merged included template "index_classificados.tpl.php" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("index_classificados.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '14249690205461f4bb0ec4e1-77544770');
content_5463a93c07b2e9_98647575($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "index_classificados.tpl.php" */?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("bloco_newsletter.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '14249690205461f4bb0ec4e1-77544770');
content_5463a93c10c845_41872964($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("bloco_popup.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '14249690205461f4bb0ec4e1-77544770');
content_5463a93c2635a8_21472914($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("analytics.tpl.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '14249690205461f4bb0ec4e1-77544770');
content_5463a93c2de053_58487371($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "analytics.tpl.php" */?>
</body>
</html><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2014-11-12 15:38:52
         compiled from "/Cloud/Sites/sal.brmalls.com.br/sal.brmalls.com.br/www/template/default/html/index_classificados.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_5463a93c07b2e9_98647575')) {function content_5463a93c07b2e9_98647575($_smarty_tpl) {?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2014-11-12 15:38:52
         compiled from "/Cloud/Sites/sal.brmalls.com.br/sal.brmalls.com.br/www/template/default/html/bloco_newsletter.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_5463a93c10c845_41872964')) {function content_5463a93c10c845_41872964($_smarty_tpl) {?><form name="FrmNewsletter" id="FrmNewsletter" method="post" class="newsletter relative">
...
</script><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2014-11-12 15:38:52
         compiled from "/Cloud/Sites/sal.brmalls.com.br/sal.brmalls.com.br/www/template/default/html/bloco_popup.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_5463a93c2635a8_21472914')) {function content_5463a93c2635a8_21472914($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['POPUP']->value!=''){?>
...
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['SRC_SCRIPT']->value;?>
popup.js"></script>
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2014-11-12 15:38:52
         compiled from "/Cloud/Sites/sal.brmalls.com.br/sal.brmalls.com.br/www/template/default/html/analytics.tpl.php" */ ?>
<?php if ($_valid && !is_callable('content_5463a93c2de053_58487371')) {function content_5463a93c2de053_58487371($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['analytics_key']!=''){?>
