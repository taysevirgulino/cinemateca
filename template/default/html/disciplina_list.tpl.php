...
<div class="row" style="padding-bottom:20px;">
	<div class="col-md-2  col-md-offset-10">
		<a href="{$URL_PATH}disciplina-add" class="btn btn-sm btn-primary btn-block">
						...
						<tbody>
							...
							<tr>
                                ...
                                <td style="text-align:center">
                                    <a href="{$URL_PATH}disciplina-edit-{$item.identificador}" title="Editar" class="btn btn-xs btn-warning ui-tooltip" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i></a>
                                    <a href="{$URL_PATH}disciplina-del-{$item.identificador}" title="Excluir" data-title="{$item.nome}" class="btn btn-xs btn-primary ui-tooltip excluir" data-toggle="tooltip" data-placement="top"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							{/foreach}
						</tbody>
