...
(function($){
  ...
  $.YTPlayer={
    ...
    width:450,
    controls:{
      play:"<img src='script/jquery/jquery.mb.YTPlayer/images/play.png'>",
      pause:"<img src='script/jquery/jquery.mb.YTPlayer/images/pause.png'>",
      mute:"<img src='script/jquery/jquery.mb.YTPlayer/images/mute.png'>",
      unmute:"<img src='script/jquery/jquery.mb.YTPlayer/images/unmute.png'>"
    },
    rasterImg:"script/jquery/jquery.mb.YTPlayer/images/raster.png",
    setYTPlayer:function(){
      var players=this;
      //$.getScript("http://ajax.googleapis.com/ajax/libs/swfobject/2/swfobject.js",function(){
	  $.getScript($.YTPlayer.path+"script/jquery/jquery.mb.YTPlayer/inc/swfobject.js",function(){
